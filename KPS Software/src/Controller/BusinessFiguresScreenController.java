...
public class BusinessFiguresScreenController implements Initializable {
    ...
    public void changeScenes(ActionEvent event) throws IOException {
        ...
        if (event.toString().contains("sendMail")) {
            Parent sendMailScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/send mail screen.fxml"));
            ...
            Parent routeDiscontinueScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/route discontinue screen.fxml"));
            ...
            Parent priceUpdateScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/price update screen.fxml"));
            ...
            Parent transportCostUpdateScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/transport cost screen.fxml"));
            ...
            Parent newRouteScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/new route screen.fxml"));
            ...
            Parent loginScreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/login screen.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        avatar.setImage(new Image(SendMailScreenController.class.getResourceAsStream("/rec/buttercup.png")));
    ...
    private void returnHome(ActionEvent event) {
        ...
        try {
            homescreen = FXMLLoader.load(BusinessFiguresScreenController.class.getResource("/rec/home screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
