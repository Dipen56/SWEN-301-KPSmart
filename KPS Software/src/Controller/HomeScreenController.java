...
public class HomeScreenController implements Initializable {
    ...
    public void changeScenes(ActionEvent event) throws IOException {
        ...
        if (event.toString().contains("sendMail")) {
            Parent sendMailScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/send mail screen.fxml"));
            ...
            Parent routeDiscontinueScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/route discontinue screen.fxml"));
            ...
            Parent priceUpdateScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/price update screen.fxml"));
            ...
            Parent transportCostUpdateScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/transport cost screen.fxml"));
            ...
            Parent newRouteScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/new route screen.fxml"));
            ...
            Parent businessFiguresScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/business figures screen.fxml"));
            ...
            Parent loginScreen = FXMLLoader.load(HomeScreenController.class.getResource("/rec/login screen.fxml"));
