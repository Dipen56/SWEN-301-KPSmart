...
public class NewRouteScreenController implements Initializable {
    ...
    public void changeScenes(ActionEvent event) throws IOException {
        ...
        if (event.toString().contains("sendMail")) {
            Parent sendMailScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/send mail screen.fxml"));
            ...
            Parent routeDiscontinueScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/route discontinue screen.fxml"));
            ...
            Parent priceUpdateScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/price update screen.fxml"));
            ...
            Parent transportCostUpdateScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/transport cost screen.fxml"));
            ...
            Parent businessFiguresScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/business figures screen.fxml"));
            ...
            Parent loginScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/login screen.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        avatar.setImage(new Image(SendMailScreenController.class.getResourceAsStream("/rec/user.png")));
    ...
    private void clearContent(ActionEvent event) {
        ...
        try {
            newRouteScreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/new route screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void returnHome(ActionEvent event) {
        ...
        try {
            homescreen = FXMLLoader.load(NewRouteScreenController.class.getResource("/rec/home screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
