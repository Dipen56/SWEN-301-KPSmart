...
public class RouteDiscontinueScreenController implements Initializable{
    ...
    public void changeScenes(ActionEvent event) throws IOException {
        ...
        if (event.toString().contains("sendMail")) {
            Parent sendMailScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/send mail screen.fxml"));
            ...
            Parent priceUpdateScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/price update screen.fxml"));
            ...
            Parent transportCostUpdateScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/transport cost screen.fxml"));
            ...
            Parent newRouteScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/new route screen.fxml"));
            ...
            Parent businessFiguresScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/business figures screen.fxml"));
            ...
            Parent loginScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/login screen.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        avatar.setImage(new Image(SendMailScreenController.class.getResourceAsStream("/rec/cool-user.png")));
    ...
    private void clearContent(ActionEvent event) {
        ...
        try {
            routeDiscontinueScreen = FXMLLoader.load(RouteDiscontinueScreenController.class.getResource("/rec/route discontinue screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
