...
public class TransportCostScreenController implements Initializable {
    ...
    public void changeScenes(ActionEvent event) throws IOException {
        ...
        if (event.toString().contains("sendMail")) {
            Parent sendMailScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/send mail screen.fxml"));
            ...
            Parent routeDiscontinueScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/route discontinue screen.fxml"));
            ...
            Parent priceUpdateScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/price update screen.fxml"));
            ...
            Parent newRouteScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/new route screen.fxml"));
            ...
            Parent businessFiguresScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/business figures screen.fxml"));
            ...
            Parent loginScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/login screen.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        avatar.setImage(new Image(SendMailScreenController.class.getResourceAsStream("/rec/female-user.png")));
    ...
    private void clearContent(ActionEvent event) {
        ...
        try {
            transportCostUpdateScreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/transport cost screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void returnHome(ActionEvent event) {
        ...
        try {
            homescreen = FXMLLoader.load(TransportCostScreenController.class.getResource("/rec/home screen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
